         ...
         <div v-if="tab === 1" id="login-wrapper"  class="global-wrapper text-center">
            ...
            <form method="POST" action="../handlers/logon.php" class="d-inline text-left">
               <div class="box">
                  ...
                  <input type="text" name="email" id="email" placeholder="Indtast email" autocomplete="username">

                  <label for="password"> <h4>Adgangskode</h4> </label>
                  <input type="password" name="password" id="password" placeholder="Indtast adgangskode" autocomplete="current-password">
         ...
         <div v-else class="global-wrapper slim text-center">
            ...
            <form method="POST" action="../handlers/signup.php" class="d-inline text-left">
               <div class="box">
                  ...
                  <input v-model="password" v-on:keyup="validatePw" type="password" name="newPassword" id="newPassword" placeholder="Indtast adgangskode" required autocomplete="new-password">

                  <label for="passwordRepeat" class="flex"> <h4>Bekræft adgangskode</h4> <span class="required">*</span></label>
                  <input v-model="passwordRepeat" v-on:keyup="validatePw" type="password" name="passwordRepeat" id="passwordRepeat" placeholder="Gentag adgangskode" required autocomplete="new-password">
